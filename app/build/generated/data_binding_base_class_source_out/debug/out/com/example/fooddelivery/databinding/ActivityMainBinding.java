...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button btnCreateAccount,
      @NonNull Button btnSignIn) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, btnCreateAccount, btnSignIn);
    }
