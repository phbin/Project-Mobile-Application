...
public final class ListviewRestaurantOrdersBinding implements ViewBinding {
  @NonNull
  ...
  private ListviewRestaurantOrdersBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ListviewRestaurantOrdersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListviewRestaurantOrdersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.listview_restaurant_orders, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListviewRestaurantOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListviewRestaurantOrdersBinding((LinearLayout) rootView, textViewAddress,
          textViewName, textViewOrderID, textViewPrice, textViewQuantity);
    }
